...
namespace SchoolDatabase.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Section")] Classes classes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Section")] Classes classes)
        {
            if (id != classes.Name)
            {
                return NotFound();
        ...
        {
          return (_context.Classes?.Any(e => e.Name == id)).GetValueOrDefault();
        }
    }
}
